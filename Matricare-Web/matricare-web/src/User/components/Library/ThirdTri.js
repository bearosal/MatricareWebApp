...
import '../../styles/library/thirdtri.css';

const FirstTri = () => {
  return (
    <div>
      <h1 className="title">Third Trimester</h1>
      <div className="image-container"style={{ height: '600px', top: '10px' }} > 
        <img src="img/bg2.jpg" alt="Third Trimester" className="thirdtri-image" />
      </div>
      <div className="third-trimester-container">
