...
import '../../styles/library/firsttri.css';

const FirstTri = () => {
  return (
    <div>
      <h1 className="title">First Trimester</h1>
      <div className="image-container"style={{ height: '600px', top: '10px'}} > 
        <img src="img/bg2.jpg" alt="First Trimester" className="firsttri-image" />
      </div>
      <div className="first-trimester-container">
