    ...
    <div className="services-container">
      <div className="row">
        ...
        <img src="img/icon1.png" alt="Service Icon" />
          ...
          <p>Connect with healthcare professionals online for convenient, personalized care without the hassle of travel or waiting rooms.</p>
          <div class="hover-image">
      ...
      <div className="row">
        <div className="service">
        <img src="img/icon4.png" alt="Service Icon" />
          <h3>Resource Library</h3>
          <p>Offering expert insights and practical guidance for every stage of parenthood.</p>
          <div class="hover-image">
            <img src="img/service4.jpg" alt="Service 4 Image" />
          </div>
        </div>
        <div className="service2">
        <img src="img/icon5.png" alt="Service Icon" />
          <h3>Online Prescription</h3>
          <p>Get prescriptions, medical advice, and guidance through virtual consultations – no in-person visits needed.</p>
          <div class="hover-image">
            <img src="img/service5.jpg" alt="Service 5 Image" />
          </div>
        </div>
        <div className="service">
        <img src="img/icon6.png" alt="Service Icon" />
          <h3>Location Navigator</h3>
          <p>Find nearby hospitals, clinics, and pharmacies, ensuring you always know where to access essential healthcare services when you need them most.</p>
          <div class="hover-image">
            <img src="img/service6.jpg" alt="Service 6 Image" />
          </div>
      </div>
    </div>
  </div>
...
<div className="shadow-box-container">
      ...
      <section id="landing-contact" className="landing-contact">
  ...
  <div className="landing-contact-box">
    ...
    <form>
      <div className="landing-form-group">
        ...
        <input type="text" id="fullName" name="fullName" placeholder="Enter your full name" className='LP-form'/>
      </div>
      <div className="landing-form-group">
        <label htmlFor="phoneNumber"></label>
        <input type="text" id="phoneNumber" name="phoneNumber" placeholder="Enter your phone number" className='LP-form'/>
      </div>
      <div className="landing-form-group">
        <label htmlFor="subject"></label>
        <input type="text" id="subject" name="subject" placeholder="Enter the subject of your message" className='LP-form'/>
      </div>
      <div className="landing-form-group">
        <label htmlFor="email"></label>
        <input type="email" id="email" name="email" placeholder="Enter your email address" className='LP-form'/>
      </div>
      <div className="landing-form-group">
        <label htmlFor="message"></label>
        <textarea id="message" name="message" placeholder="Write your message here" className='LP-textarea' ></textarea>
      </div>
      <button className="landing-button1" type="submit">SEND A MESSAGE</button>
    </form>
  </div>
</section>
    </div>
